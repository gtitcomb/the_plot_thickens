...
### Demo code to make cool circular plots!
...
# can also do faceting (turn off annotation above first):

  #+facet_wrap(~species) ## free scales not supported currently, so you'd have to transform the data beforehand for this

# lots of other options to clean up things also! (e.g. rename variables, add titles etc.)

# here's the plot in non-circular format as well:
